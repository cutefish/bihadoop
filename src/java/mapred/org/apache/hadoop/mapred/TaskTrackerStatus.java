...
public class TaskTrackerStatus implements Writable {
  ...
  //Added by xyu40@gatech.edu
  private BlockCacheStatus blockCacheStatus;

  public void setBlockCacheStatus(BlockCacheStatus status) {
    blockCacheStatus = status;
  }
  
  public Segments getCachedSegments() {
    return blockCacheStatus.segments;
  }

  public long getDiskCacheCapacity() {
    return blockCacheStatus.diskCacheCapacity;
  }

  public long getMemoryCacheCapacity() {
    return blockCacheStatus.memoryCacheCapacity;
  }
  //end xyu40@gatech.edu
