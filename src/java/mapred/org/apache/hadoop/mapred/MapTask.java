...
class MapTask extends Task {
  ...
  public void run(final JobConf job, final TaskUmbilicalProtocol umbilical) 
    ...
    LOG.info("==> maptask prepare. task id: " + conf.get("mapred.task.id") + 
             " time: " + (end - start) + " ms");
    //end xyu40@gatech.edu
    if (useNewApi) {
      //added by xyu40@gatech.edu
      ...
      LOG.info("==> maptask run. task id: " + conf.get("mapred.task.id") + 
               " time: " + (end - start) + " ms");
      //end xyu40@gatech.edu
    } else {
    ...
    LOG.info("==> maptask done. task id: " + conf.get("mapred.task.id") + 
             " time: " + (end - start) + " ms");
    //end xyu40@gatech.edu
  }
  @SuppressWarnings("unchecked")
...
start = System.currentTimeMillis();
    ...
    LOG.info("==> runNewMapper prepare. task id: " + conf.get("mapred.task.id") + 
             " time: " + (end - start) + " ms");
    //end xyu40@gatech.edu
    try {
      //added by xyu40@gatech.edu
      ...
      LOG.info("==> runNewMapper context init." + 
               " task id: " + conf.get("mapred.task.id") + 
               " time: " + (end - start) + " ms");
      //end xyu40@gatech.edu
      //added by xyu40@gatech.edu
      start = System.currentTimeMillis();
      ...
      LOG.info("==> runNewMapper run. task id: " + conf.get("mapred.task.id") + 
               " time: " + (end - start) + " ms");
      //end xyu40@gatech.edu
      //added by xyu40@gatech.edu
      start = System.currentTimeMillis();
      ...
      LOG.info("==> runNewMapper close. task id: " + conf.get("mapred.task.id") + 
               " time: " + (end - start) + " ms");
      //end xyu40@gatech.edu
