...
public class GIMV {
	...
	//            oc
	public static<T> ArrayList<VectorElem<T>> parseVectorVal(
      String strVal, Class<T> type) {
	...
	// strVal is msu(ROW-ID   VALUE)s. ex) 0 0.5 1 0.3
	//            oc
	public static ArrayList<VectorElem<Double>> multDiagVector(
      String strDiag, String strVec, int block_width) {
    short i;
  ...
  //                false (otherwise)
  public static boolean IsCompleteHADIVector(
      ArrayList<VectorElem<String>> arr) {
	...
	public static ArrayList<VectorElem<Integer>> minBlockVector(
      ArrayList<BlockElem<Integer>> block, 
      ArrayList<VectorElem<Integer>> vector, 
      int block_width, int isFastMethod) {
	...
	public static ArrayList<VectorElem<String>> bworBlockVector(
      ArrayList<BlockElem<Integer>> block, 
      ArrayList<VectorElem<String>> vector, 
      int block_width, int nreplication, int encode_bitmask) {
	...
	public static ArrayList<VectorElem<Double>> multBlockVector(
      ArrayList<BlockElem<Double>> block, 
      ArrayList<VectorElem<Double>> vector, int i_block_width) {
	...
	// return : result vector
	public static ArrayList<VectorElem<Double>> multBlockVector(
      byte[] block, ArrayList<VectorElem<Double>> vector, int i_block_width) {
		double[] out_vals = new double[i_block_width];	// buffer to save output
		short i;
